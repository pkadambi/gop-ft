...
class TrainCrossValStage(AtomicStage):
    ...
    def run(self):
        ...
        for fold in range(fold_amount):
            ...
            config_dict["train-list-path"] = config_dict["train-sample-list-dir"] + 'train_sample_list_fold_' + str(
                fold)
...
class GenerateScoresCrossValStage(AtomicStage):
    ...
    def run(self):
        ...
        for fold in range(config_dict["folds"]):
            ...
            cat_file_names += config_dict['gop-scores-dir'] + '/' + 'gop-' + config_dict[
                'model-name'] + '.txt '  # Codigo repetido con generate_score_txt
